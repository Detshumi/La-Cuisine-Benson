                ...
                <div className="mx-auto w-full max-w-4xl flex justify-center pt-8">
                    <div className="grid place-items-start grid-cols-1 md:grid-cols-2 gap-y-3 md:gap-x-24 w-full">
                            ...
                            <CardContent>
                                <form id="product-form" onSubmit={submitProduct} className="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <Input value={productForm.data.thumbnail} onChange={(e:any)=> productForm.setData('thumbnail', e.target.value)} />
                                    </div>
                                    <div>
                                ...
                                <div className="mt-4 flex justify-end">
                                    <Button form="product-form" type="submit" className="bg-emerald-400 text-white hover:bg-emerald-500">Add Product</Button>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="relative w-full max-w-sm">
                            <CardHeader>
                                <CardTitle>Products</CardTitle>
                                <CardDescription>Existing products</CardDescription>
                            </CardHeader>
                            <CardContent>
                                {products.length === 0 ? (
